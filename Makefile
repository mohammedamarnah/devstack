...
logs: ## View logs from containers running in detached mode
	docker-compose -f docker-compose.yml -f docker-compose-analytics-pipeline.yml -f docker-compose-state-manager.yml logs -f --tail 0 docker-compose-edraak-judge.yml logs -f --tail 0
